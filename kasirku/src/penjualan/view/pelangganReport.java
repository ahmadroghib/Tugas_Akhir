 ...
 * @author rizkiramdani
 */
public final class pelangganReport extends javax.swing.JFrame {
List<pelanggan> record=new ArrayList<pelanggan>();
    pelangganInterfc plgServis;
    int row;
    /**
     * Creates new form pelangganReport
     */
    public pelangganReport() {
        initComponents();
        plgServis = new pelangganImplement();
        TableLapPelanggan.getSelectionModel().addListSelectionListener(
                new ListSelectionListener() {
                    public void valueChanged(ListSelectionEvent e) {
                        row=TableLapPelanggan.getSelectedRow();
                        if(row!=-1){
    ...
    void isiTabel(){
        ...
        TableLapPelanggan.setModel(new DefaultTableModel(data, judul));
        jScrollPane1.setViewportView(TableLapPelanggan);
    }
    ...
    private void initComponents() {
        ...
        TableLapPelanggan = new javax.swing.JTable();
        ...
        jLabel3.setText("Cetak Laporan Data Pelanggan");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 22)); // NOI18N
        jLabel2.setText("LAPORAN DATA PELANGGAN");
        ...
        TableLapPelanggan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Id_Pelanggan", "Nama ", "Jenis Kelamin", "Alamat", "No Tlpn"
            }
        ));
        jScrollPane1.setViewportView(TableLapPelanggan);

        buttonTransparan1.setText("CETAK LAPORAN DATA PELANGGAN");
        ...
        background21Layout.setHorizontalGroup(
            ...
            .addComponent(buttonTransparan1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private javax.swing.JTable TableLapPelanggan;
